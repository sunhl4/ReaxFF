...
********************************************************************** 
      ...
      iortho=1
      if (qr.eq.'F'.or.qr.eq.'Y'.or.qr.eq.'3'.or.qr.eq.'5'.
     $or.qr.eq.'P'.or.qr.eq.'B'.or.qr.eq.'S'.or.qr.eq.'R') then 
...
********************************************************************** 
      ...
      if (bo(i1)*bo(i2).lt.0.00001) goto 50   !Scott Habershon
      k7=ib(i2,2)
      k8=ib(i2,3)
...
********************************************************************** 
     ...
     $atomtemp(i1),iag(i1,3+mbond)
      if (ixmolo.eq.6) write (68,1400)qa(i1),(c(i1,i2),i2=1,3),
...
************************************************************************
   ...
   15 read (63,'(a100)',err=9010,end=500)qhulp
     ...
     $istart=istart+1
      ...
      call stranal(istart,iend,vout,iout,2)
      vdiv(i1)=vout
      if (abs(vdiv(i1)).gt.0.0001) then
      nhulp=nhulp+1
      istart=iend
      istart2=iend
      if (vdiv(i1).lt.10.0) write (qdiv(nhulp),
     $'(a1,f4.2,a1)')'/',vdiv(i1),' '
*     if (vdiv(i1).ge.10.0) write (qdiv(nhulp),
*    $'(a1,f4.1,a1)')'/',vdiv(i1),' '
...
*     end if
     ...
     $c(na+1,3),qffty(na+1),ibgr1(na+1),ibgr2(na+1),chgbgf(na+1)
      ...
      if (qlabhulp(1:2).eq.'Cr') qa(na+1)='Cr'
...
********************************************************************** 
   ...
   30 read (19,'(a200)',end=900,err=900)qhulp
     ...
     $ir,qlabhulp,cadd(naa+1,1),cadd(naa+1,2),cadd(naa+1,3)
      ...
      if (qlabhulp(1:2).eq.'Cs') qadd(naa+1)='Cs'
      if (qlabhulp(1:2).eq.'Sr') qadd(naa+1)='Sr'
      ityadd(naa+1)=0
